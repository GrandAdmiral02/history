      ...
      <section className="relative h-[500px] md:h-[600px] lg:h-[700px] overflow-hidden">
        ...
        <div className="container relative z-20 flex flex-col items-center justify-center h-full text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <Button asChild size="lg" className="bg-green-700 hover:bg-green-800 transition-all duration-300 shadow-md">
              <Link href="/destinations">Khám Phá Ngay</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="text-white border-white hover:bg-white/20 transition-all duration-300">
        ...
        <div className="container">
          <div className="flex flex-col items-center text-center mb-12">
            <div className="inline-block border-b-2 border-green-700 pb-1 mb-4">
              <span className="text-sm uppercase tracking-wider text-green-700 font-semibold">Khám phá</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Bản Đồ Di Tích</h2>
            <p className="text-muted-foreground max-w-3xl">
              Khám phá vị trí địa lý của các di tích lịch sử quan trọng tại Nghệ An
            </p>
          </div>
          <div className="w-full rounded-lg overflow-hidden shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
            <MapComponent height="450px" zoom={9} mapProvider="MAPBOX" mapStyle="streets" />
          </div>
