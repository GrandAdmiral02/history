-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('USER', 'GUIDE', 'ADMIN_TOUR', 'ADMIN_SHOP', 'SUPER_ADMIN');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CREDIT_CARD', 'E_WALLET', 'BANK_TRANSFER', 'CASH');
...
CREATE TABLE "orders" (
    ...
    "shippingFee" DOUBLE PRECISION NOT NULL DEFAULT 30000,
