...
export default async function AdminDashboardPage() {
  ...
  if (
    !session ||
    !session.user ||
    !["ADMIN_TOUR", "ADMIN_SHOP", "SUPER_ADMIN"].includes(
      session.user.role || "",
    )
  ) {
        ...
        {(userRole === "ADMIN_TOUR" || userRole === "SUPER_ADMIN") && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Quản lý tours và bookings</CardDescription>
            </CardHeader>
        ...
        {userRole === "SUPER_ADMIN" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Chỉ dành cho Super Admin</CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              <Link
                href="/admin/users"
