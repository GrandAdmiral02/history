        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-10">
            <div className="prose prose-lg max-w-none">
              ...
              <ul>
                <li>Giáo dục thế hệ trẻ về truyền thống lịch sử, văn hóa và tinh thần yêu nước của dân tộc</li>
                <li>Phát triển du lịch bền vững, tạo việc làm và thu nhập cho người dân địa phương</li>
                <li>Nghiên cứu khoa học về lịch sử, văn hóa, kiến trúc và nghệ thuật truyền thống</li>
                <li>Tăng cường bản sắc dân tộc và niềm tự hào dân tộc</li>
                <li>Thúc đẩy giao lưu, hợp tác quốc tế trong lĩnh vực văn hóa, du lịch</li>
              </ul>
              ...
              <ol>
                <li>
                  <strong>Cung cấp thông tin chi tiết và đáng tin cậy</strong> về các di tích lịch sử, danh lam thắng cảnh tại Nghệ An, giúp du khách có được hiểu biết sâu sắc về giá trị lịch sử, văn hóa của từng địa điểm.
                </li>
                <li>
                  <strong>Quảng bá và giới thiệu</strong> vẻ đẹp và sự phong phú của di sản văn hóa, lịch sử Nghệ An đến với du khách trong nước và quốc tế.
                </li>
                <li>
                  <strong>Hỗ trợ và hướng dẫn du khách</strong> trong việc lập kế hoạch, lịch trình tham quan các điểm di tích lịch sử tại Nghệ An một cách hiệu quả.
                </li>
                <li>
                  <strong>Kết nối cộng đồng</strong> những người yêu thích lịch sử, văn hóa và du lịch, tạo diễn đàn chia sẻ kinh nghiệm, cảm nhận sau mỗi chuyến đi.
                </li>
                <li>
                  <strong>Góp phần bảo tồn và phát huy</strong> giá trị di sản văn hóa, lịch sử của dân tộc thông qua việc nâng cao nhận thức của cộng đồng về tầm quan trọng của các di tích.
                </li>
              </ol>
          ...
          <div className="space-y-8">
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="bg-green-100 px-6 py-4">
                <h3 className="text-lg font-semibold text-green-800">Thông tin liên hệ</h3>
              </div>
              <div className="p-6 space-y-4">
                <div>
                  <h4 className="font-medium">Email</h4>
                  <p className="text-sm text-muted-foreground">info@nghean-historical.vn</p>
                </div>
                <div>
                  <h4 className="font-medium">Điện thoại</h4>
                  <p className="text-sm text-muted-foreground">+84 238 1234 567</p>
                </div>
                <div>
                  <h4 className="font-medium">Địa chỉ</h4>
                  <p className="text-sm text-muted-foreground">Thành phố Vinh, Nghệ An, Việt Nam</p>
                </div>
              </div>
            </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="bg-green-100 px-6 py-4">
                <h3 className="text-lg font-semibold text-green-800">Liên kết hữu ích</h3>
              </div>
              <div className="p-6 space-y-4">
                <ul className="space-y-3">
                  <li>
                    <a href="https://dulich.nghean.gov.vn" target="_blank" rel="noopener noreferrer" className="text-sm text-green-700 hover:underline">
                      Sở Du lịch Nghệ An
                    </a>
                  </li>
                  <li>
                    <a href="https://www.vietnamtourism.gov.vn" target="_blank" rel="noopener noreferrer" className="text-sm text-green-700 hover:underline">
                      Cục Du lịch Quốc gia Việt Nam
                    </a>
                  </li>
                  <li>
                    <a href="https://www.nghean.gov.vn" target="_blank" rel="noopener noreferrer" className="text-sm text-green-700 hover:underline">
                      UBND tỉnh Nghệ An
                    </a>
                  </li>
                  <li>
                    <a href="https://www.baonghean.vn" target="_blank" rel="noopener noreferrer" className="text-sm text-green-700 hover:underline">
                      Báo Nghệ An
                    </a>
                  </li>
                </ul>
